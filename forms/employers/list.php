<html>
<div class="m-3" id="yongerEmployers" wb-allow="admin,partner">

    <nav class="nav navbar navbar-expand-md col">
        <h3 class="tx-bold tx-spacing--2 order-1">Работодатели</h3>
        ...
        <div class="collapse navbar-collapse order-2" id="navbarSupportedContent">
            <form class="form-inline mg-t-10 mg-lg-0  ml-auto">
                <div class="form-group">
                    ...
                    <a href="#" data-ajax="{'url':'/cms/ajax/form/employers/edit/_new','html':'#yongerEmployers modals'}"
    ...
    <table class="table table-striped table-hover tx-15">
        ...
        <tbody id="EmployersList">
            <wb-foreach wb="table=employers&sort=_created:d&bind=cms.list.employers&sort=_created:d&size={{_sett.page_size}}"
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:"
                            data-ajax="{'url':'/cms/ajax/form/employers/edit/{{id}}','html':'#yongerEmployers modals'}"
                            class="d-inline">
                            <img src="/module/myicons/content-edit-pen.svg?size=24&stroke=323232">
                        </a>
                        <a href="javascript:"
                            data-ajax="{'url':'/ajax/rmitem/employers/{{id}}','update':'cms.list.employers','html':'#yongerEmployers modals'}"
                            class="d-inline">
